...
<a href="https://github.com/camaraproject/TestRepo/graphs/contributors" title="Contributors"><img src="https://img.shields.io/github/contributors/camaraproject/TestRepo?style=plastic"></a>
<a href="https://github.com/camaraproject/TestRepo" title="Repo Size"><img src="https://img.shields.io/github/repo-size/camaraproject/TestRepo?style=plastic"></a>
...
Sandbox API Repository to describe, develop, document, and test the TestRepo Service API(s). The repository does not yet belong to a CAMARA Sub Project.
...
Sandbox API Repository to describe, develop, document, and test the TestRepo Service API(s) within the Sub Project [ReleaseManagement](https://lf-camaraproject.atlassian.net/wiki/x/VA7e).
...
Incubating API Repository to evolve and maintain the definitions and documentation of TestRepo Service API(s) within the Sub Project [ReleaseManagement](https://lf-camaraproject.atlassian.net/wiki/x/VA7e)
...
Repository for xxx of the ReleaseManagement Working Group"
...
* Service API(s) “TestRepo” (see APIBacklog.md) 
...
* Mailing List
  ...
  * Subscribe / Unsubscribe to the mailing list <https://lists.camaraproject.org/g/sp-xxx>.
  * A message to the community of this Sub Project can be sent using <sp-xxx@lists.camaraproject.org>.
